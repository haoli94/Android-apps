...
//			System.out.print(point);
	...
	*/
	public int[] getSkirt() {
		...
		//Initialize the skirt with length 4
		...
		//Store the lowest y in the skirt
		skirt = new int[width];
	...
	*/
	public boolean equals(Object obj) {
		...
		// Compare all the coordinates to determine if the two pieces are the same
		// YOUR CODE HERE
		return equal;
	}
	...
	*/
	public static Piece[] getPieces() {
		...
		// Call the class method makeFastRotations and store the results into piece array
	...
	*/
	private static Piece makeFastRotations(Piece root) {
        ...
        // Connect all the rotations by next
        prev.next = root;
